# -*- coding: utf-8 -*-
"""
Created on Tue Nov  3 16:07:38 2020
...
import os
print(os.getcwd())
os.chdir("C:\\Users\cp\Downloads\Dir")
...
# define the lower and upper boundaries of yellow object in the HSV color space
...
while True:
    ...
    # crteate a mask for the yellow color and perform dilation and erosion to remove any small
